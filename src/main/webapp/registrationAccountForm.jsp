...
<%@ page import="javax.servlet.http.HttpServlet,ru.myOnlineShop.model.customer.ClientAccount,ru.myOnlineShop.model.constanta.StatusAccount"%>
...
else if(clientAccount != null && clientAccount.getStatusAccount().equals(StatusAccount.ADMIN)){
%>
<h3>Данные Аккаунта</h3>
    <form action="/regAccount" method="post">
        <label for="login">Логин:</label><br>
