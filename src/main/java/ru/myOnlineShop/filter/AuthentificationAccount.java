package ru.myOnlineShop.filter;
...
public class AuthentificationAccount implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain) throws IOException, ServletException {
        ...
        @SuppressWarnings("unchecked") final AtomicReference<AccountDataBaseProject> accountDataBase = (AtomicReference<AccountDataBaseProject>) req.getServletContext().getAttribute("accountDataBase");
